    ...
    return(
        ...
        <ScrollView contentContainerStyle={{width:'100%',paddingBottom:20}} showsHorizontalScrollIndicator={false} indicatorStyle='white' >
            <View style={styles.container1}>
                ...
                <View style={styles.Viewallcontainer}><TouchableOpacity containerStyle={{flex:1}}><Text style={styles.browsetxtcontainertxt,{color:'red'}} >View All</Text></TouchableOpacity></View>
            </View>
